...
@Dao
@ConfigAutowireable
public interface Base001UserEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base001UserEntity}
     */
    @Select
    Base001UserEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base001UserEntity entity);
     ...
     */
    @Update
    int update(Base001UserEntity entity);
    ...
    int[] insert(java.util.List<Base001UserEntity> entities);
    ...
    int[] update(java.util.List<Base001UserEntity> entities);
    ...
    int[] delete(java.util.List<Base001UserEntity> entities);
