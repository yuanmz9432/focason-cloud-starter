...
@Dao
@ConfigAutowireable
public interface Base003UserTokenEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base003UserTokenEntity}
     */
    @Select
    Base003UserTokenEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base003UserTokenEntity entity);
     ...
     */
    @Update
    int update(Base003UserTokenEntity entity);
    ...
    int[] insert(java.util.List<Base003UserTokenEntity> entities);
    ...
    int[] update(java.util.List<Base003UserTokenEntity> entities);
    ...
    int[] delete(java.util.List<Base003UserTokenEntity> entities);
