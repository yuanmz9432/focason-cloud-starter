...
@Dao
@ConfigAutowireable
public interface Base004NotificationEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base004NotificationEntity}
     */
    @Select
    Base004NotificationEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base004NotificationEntity entity);
     ...
     */
    @Update
    int update(Base004NotificationEntity entity);
    ...
    int[] insert(java.util.List<Base004NotificationEntity> entities);
    ...
    int[] update(java.util.List<Base004NotificationEntity> entities);
    ...
    int[] delete(java.util.List<Base004NotificationEntity> entities);
