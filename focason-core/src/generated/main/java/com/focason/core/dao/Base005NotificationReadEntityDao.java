...
@Dao
@ConfigAutowireable
public interface Base005NotificationReadEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base005NotificationReadEntity}
     */
    @Select
    Base005NotificationReadEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base005NotificationReadEntity entity);
     ...
     */
    @Update
    int update(Base005NotificationReadEntity entity);
    ...
    int[] insert(java.util.List<Base005NotificationReadEntity> entities);
    ...
    int[] update(java.util.List<Base005NotificationReadEntity> entities);
    ...
    int[] delete(java.util.List<Base005NotificationReadEntity> entities);
