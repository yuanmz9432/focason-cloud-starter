...
@Dao
@ConfigAutowireable
public interface Base006EmailLogEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base006EmailLogEntity}
     */
    @Select
    Base006EmailLogEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base006EmailLogEntity entity);
     ...
     */
    @Update
    int update(Base006EmailLogEntity entity);
    ...
    int[] insert(java.util.List<Base006EmailLogEntity> entities);
    ...
    int[] update(java.util.List<Base006EmailLogEntity> entities);
    ...
    int[] delete(java.util.List<Base006EmailLogEntity> entities);
