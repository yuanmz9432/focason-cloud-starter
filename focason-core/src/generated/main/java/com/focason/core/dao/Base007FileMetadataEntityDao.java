...
@Dao
@ConfigAutowireable
public interface Base007FileMetadataEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Base007FileMetadataEntity}
     */
    @Select
    Base007FileMetadataEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Base007FileMetadataEntity entity);
     ...
     */
    @Update
    int update(Base007FileMetadataEntity entity);
    ...
    int[] insert(java.util.List<Base007FileMetadataEntity> entities);
    ...
    int[] update(java.util.List<Base007FileMetadataEntity> entities);
    ...
    int[] delete(java.util.List<Base007FileMetadataEntity> entities);
