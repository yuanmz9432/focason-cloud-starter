...
@Dao
@ConfigAutowireable
public interface Io001FileTaskEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Io001FileTaskEntity}
     */
    @Select
    Io001FileTaskEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Io001FileTaskEntity entity);
     ...
     */
    @Update
    int update(Io001FileTaskEntity entity);
    ...
    int[] insert(java.util.List<Io001FileTaskEntity> entities);
    ...
    int[] update(java.util.List<Io001FileTaskEntity> entities);
    ...
    int[] delete(java.util.List<Io001FileTaskEntity> entities);
