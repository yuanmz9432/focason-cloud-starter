...
import com.focason.core.entity.Iv001ZoneEntity;
...
@Dao
@ConfigAutowireable
public interface Iv001ZoneEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Iv001ZoneEntity}
     */
    @Select
    Iv001ZoneEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Iv001ZoneEntity entity);
     ...
     */
    @Update
    int update(Iv001ZoneEntity entity);
    ...
    int[] insert(java.util.List<Iv001ZoneEntity> entities);
    ...
    int[] update(java.util.List<Iv001ZoneEntity> entities);
    ...
    int[] delete(java.util.List<Iv001ZoneEntity> entities);
