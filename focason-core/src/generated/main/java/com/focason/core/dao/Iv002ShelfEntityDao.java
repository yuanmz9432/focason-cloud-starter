...
import com.focason.core.entity.Iv002ShelfEntity;
...
@Dao
@ConfigAutowireable
public interface Iv002ShelfEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Iv002ShelfEntity}
     */
    @Select
    Iv002ShelfEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Iv002ShelfEntity entity);
     ...
     */
    @Update
    int update(Iv002ShelfEntity entity);
    ...
    int[] insert(java.util.List<Iv002ShelfEntity> entities);
    ...
    int[] update(java.util.List<Iv002ShelfEntity> entities);
    ...
    int[] delete(java.util.List<Iv002ShelfEntity> entities);
