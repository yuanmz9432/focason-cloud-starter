...
import com.focason.core.entity.Iv005InboundEntity;
...
@Dao
@ConfigAutowireable
public interface Iv005InboundEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Iv005InboundEntity}
     */
    @Select
    Iv005InboundEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Iv005InboundEntity entity);
     ...
     */
    @Update
    int update(Iv005InboundEntity entity);
    ...
    int[] insert(java.util.List<Iv005InboundEntity> entities);
    ...
    int[] update(java.util.List<Iv005InboundEntity> entities);
    ...
    int[] delete(java.util.List<Iv005InboundEntity> entities);
