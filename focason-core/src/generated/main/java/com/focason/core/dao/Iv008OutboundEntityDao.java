...
import com.focason.core.entity.Iv008OutboundEntity;
...
@Dao
@ConfigAutowireable
public interface Iv008OutboundEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Iv008OutboundEntity}
     */
    @Select
    Iv008OutboundEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Iv008OutboundEntity entity);
     ...
     */
    @Update
    int update(Iv008OutboundEntity entity);
    ...
    int[] insert(java.util.List<Iv008OutboundEntity> entities);
    ...
    int[] update(java.util.List<Iv008OutboundEntity> entities);
    ...
    int[] delete(java.util.List<Iv008OutboundEntity> entities);
