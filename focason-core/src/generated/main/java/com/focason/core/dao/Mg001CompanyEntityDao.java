...
import com.focason.core.entity.Mg001CompanyEntity;
...
@Dao
@ConfigAutowireable
public interface Mg001CompanyEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg001CompanyEntity}
     */
    @Select
    Mg001CompanyEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg001CompanyEntity entity);
     ...
     */
    @Update
    int update(Mg001CompanyEntity entity);
    ...
    int[] insert(java.util.List<Mg001CompanyEntity> entities);
    ...
    int[] update(java.util.List<Mg001CompanyEntity> entities);
    ...
    int[] delete(java.util.List<Mg001CompanyEntity> entities);
