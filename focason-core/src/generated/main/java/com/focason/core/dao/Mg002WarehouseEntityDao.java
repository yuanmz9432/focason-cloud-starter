...
import com.focason.core.entity.Mg002WarehouseEntity;
...
@Dao
@ConfigAutowireable
public interface Mg002WarehouseEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg002WarehouseEntity}
     */
    @Select
    Mg002WarehouseEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg002WarehouseEntity entity);
     ...
     */
    @Update
    int update(Mg002WarehouseEntity entity);
    ...
    int[] insert(java.util.List<Mg002WarehouseEntity> entities);
    ...
    int[] update(java.util.List<Mg002WarehouseEntity> entities);
    ...
    int[] delete(java.util.List<Mg002WarehouseEntity> entities);
