...
import com.focason.core.entity.Mg003ClientEntity;
...
@Dao
@ConfigAutowireable
public interface Mg003ClientEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg003ClientEntity}
     */
    @Select
    Mg003ClientEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg003ClientEntity entity);
     ...
     */
    @Update
    int update(Mg003ClientEntity entity);
    ...
    int[] insert(java.util.List<Mg003ClientEntity> entities);
    ...
    int[] update(java.util.List<Mg003ClientEntity> entities);
    ...
    int[] delete(java.util.List<Mg003ClientEntity> entities);
