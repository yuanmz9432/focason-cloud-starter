...
import com.focason.core.entity.Mg005UserEntity;
...
@Dao
@ConfigAutowireable
public interface Mg005UserEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg005UserEntity}
     */
    @Select
    Mg005UserEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg005UserEntity entity);
     ...
     */
    @Update
    int update(Mg005UserEntity entity);
    ...
    int[] insert(java.util.List<Mg005UserEntity> entities);
    ...
    int[] update(java.util.List<Mg005UserEntity> entities);
    ...
    int[] delete(java.util.List<Mg005UserEntity> entities);
