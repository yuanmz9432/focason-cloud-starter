...
import com.focason.core.entity.Mg008SponsorEntity;
...
@Dao
@ConfigAutowireable
public interface Mg008SponsorEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg008SponsorEntity}
     */
    @Select
    Mg008SponsorEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg008SponsorEntity entity);
     ...
     */
    @Update
    int update(Mg008SponsorEntity entity);
    ...
    int[] insert(java.util.List<Mg008SponsorEntity> entities);
    ...
    int[] update(java.util.List<Mg008SponsorEntity> entities);
    ...
    int[] delete(java.util.List<Mg008SponsorEntity> entities);
