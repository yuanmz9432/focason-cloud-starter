...
import com.focason.core.entity.Mg014FileEntity;
...
@Dao
@ConfigAutowireable
public interface Mg014FileEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Mg014FileEntity}
     */
    @Select
    Mg014FileEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Mg014FileEntity entity);
     ...
     */
    @Update
    int update(Mg014FileEntity entity);
    ...
    int[] insert(java.util.List<Mg014FileEntity> entities);
    ...
    int[] update(java.util.List<Mg014FileEntity> entities);
    ...
    int[] delete(java.util.List<Mg014FileEntity> entities);
