...
import com.focason.core.entity.Od001OrderEntity;
...
@Dao
@ConfigAutowireable
public interface Od001OrderEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Od001OrderEntity}
     */
    @Select
    Od001OrderEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Od001OrderEntity entity);
     ...
     */
    @Update
    int update(Od001OrderEntity entity);
    ...
    int[] insert(java.util.List<Od001OrderEntity> entities);
    ...
    int[] update(java.util.List<Od001OrderEntity> entities);
    ...
    int[] delete(java.util.List<Od001OrderEntity> entities);
