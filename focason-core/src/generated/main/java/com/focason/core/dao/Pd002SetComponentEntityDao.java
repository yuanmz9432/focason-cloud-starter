...
@Dao
@ConfigAutowireable
public interface Pd002SetComponentEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Pd002SetComponentEntity}
     */
    @Select
    Pd002SetComponentEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Pd002SetComponentEntity entity);
     ...
     */
    @Update
    int update(Pd002SetComponentEntity entity);
    ...
    int[] insert(java.util.List<Pd002SetComponentEntity> entities);
    ...
    int[] update(java.util.List<Pd002SetComponentEntity> entities);
    ...
    int[] delete(java.util.List<Pd002SetComponentEntity> entities);
