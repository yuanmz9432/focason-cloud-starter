...
import com.focason.core.entity.Sp001ShipmentEntity;
...
@Dao
@ConfigAutowireable
public interface Sp001ShipmentEntityDao
{
     ...
     *
     * @param id 主キー
     * @return {@link Sp001ShipmentEntity}
     */
    @Select
    Sp001ShipmentEntity selectById(int id);
     ...
     */
    @Insert
    int insert(Sp001ShipmentEntity entity);
     ...
     */
    @Update
    int update(Sp001ShipmentEntity entity);
    ...
    int[] insert(java.util.List<Sp001ShipmentEntity> entities);
    ...
    int[] update(java.util.List<Sp001ShipmentEntity> entities);
    ...
    int[] delete(java.util.List<Sp001ShipmentEntity> entities);
