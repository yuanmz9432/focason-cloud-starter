...
import com.focason.core.entity.Vw001InventorySearchEntity;
...
@Dao
@ConfigAutowireable
public interface Vw001InventorySearchEntityDao
{
     ...
     */
    @Insert
    int insert(Vw001InventorySearchEntity entity);
     ...
     */
    @Update
    int update(Vw001InventorySearchEntity entity);
    ...
    int[] insert(java.util.List<Vw001InventorySearchEntity> entities);
    ...
    int[] update(java.util.List<Vw001InventorySearchEntity> entities);
    ...
    int[] delete(java.util.List<Vw001InventorySearchEntity> entities);
