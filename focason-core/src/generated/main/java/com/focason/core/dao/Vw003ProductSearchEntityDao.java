...
import com.focason.core.entity.Vw003ProductSearchEntity;
...
@Dao
@ConfigAutowireable
public interface Vw003ProductSearchEntityDao
{
     ...
     */
    @Insert
    int insert(Vw003ProductSearchEntity entity);
     ...
     */
    @Update
    int update(Vw003ProductSearchEntity entity);
    ...
    int[] insert(java.util.List<Vw003ProductSearchEntity> entities);
    ...
    int[] update(java.util.List<Vw003ProductSearchEntity> entities);
    ...
    int[] delete(java.util.List<Vw003ProductSearchEntity> entities);
