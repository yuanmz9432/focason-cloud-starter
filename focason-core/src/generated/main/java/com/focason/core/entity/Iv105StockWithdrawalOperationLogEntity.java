 ...
 */
@Entity
@Table(catalog = "focason", name = "iv105_stock_withdrawal_operation_log")
public class Iv105StockWithdrawalOperationLogEntity extends FsEntity
{
    /** 行ID */
    @Id
    ...
    /** 操作タイプ:1:出庫開始, 2:出庫承認, 3:梱包, 4:出荷, 5:キャンセル処理, 6:異常報告 */
