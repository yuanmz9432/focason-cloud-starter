...
// =====================================================
package com.focason.base.auth.service;


import com.focason.base.user.repository.UserRepository;
import com.focason.base.user.service.UserService;
 ...
 * @version 1.0.0
 * @since 1.0.0
 * @see com.focason.base.user.repository.UserRepository
...
public class AuthenticationService
{
    ...
    public UserLoginResponse generateLoginResponse(UserResource resource) {
        ...
        return UserLoginResponse.builder()
            ...
            .expiresAt(FsUtilityToolkit.toTokyoEpochSeconds(expiresAt))
            .expiresIn(expiresIn)
            .refreshToken(refreshToken)
            .deviceId(deviceId)
            .user(FsUtilityToolkit.convert(resource, UserLoginResponse.User.class)).build();
    }
